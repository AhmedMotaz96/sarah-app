...
auth(endPoint.deleteMessage),
messageController.deleteMessage)
router.patch("/message/:id",validation(messageValidators.updateMessage),
auth(endPoint.updateMessage),messageController.updateMessage)
